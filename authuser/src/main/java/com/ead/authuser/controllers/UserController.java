...
public class UserController {
    ...
    public ResponseEntity<Page<UserModel>> getAllUsers( SpecificationTemplate.UserSpec spec,
        ...
        Page<UserModel> userModelPage = userService.findAll(spec, pageable); //spec é de uma biblioteca para filtros avancados as classes são ResolverConfig e SpecificationTemplate
